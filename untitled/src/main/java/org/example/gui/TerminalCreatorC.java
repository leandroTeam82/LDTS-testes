...
public class TerminalCreatorC implements TerminalCreator {
    private final DefaultTerminalFactory terminalFactory;
    private final TerminalSize terminalSize;
    private final Rectangle defaultBounds;

    public TerminalCreatorC(DefaultTerminalFactory terminalFactory, TerminalSize terminalSize, Rectangle defaultBounds) {
    ...
    @Override
    public Screen createScreen(ResizableTerminal.Resolution resolution, String title)
    ...
    private Rectangle getTerminalBounds(ResizableTerminal.Resolution resolution) {
        if (resolution == null)
